...
(function (global) {
  ...
  var list = [
    ...
    [2, 'halbleiter-chips', 'Halbleiter & Chips', 'GPUs, CPUs, Foundries, Equipment', 'Die Rechenkraft hinter jedem Fortschritt.', 'Kleine Chips. Große Wirkung.', '#3867ff', 'tech'],
    [3, 'rechenzentren-cloud', 'Rechenzentren & Cloud', 'Datacenter, Hyperscaler, Infrastruktur', 'Das Fundament der digitalen Welt.', 'Daten brauchen ein Zuhause.', '#2f7dd8', 'tech'],
    [4, 'cybersecurity', 'Cybersecurity', 'Digitale Sicherheit und Netzwerke', 'Schutz für eine vernetzte Welt.', 'Vertrauen ist Infrastruktur.', '#1f9c8f', 'tech'],
    [5, 'quantencomputing', 'Quantencomputing', 'Quantum Hardware & Software', 'Rechnen jenseits der Grenzen.', 'Die nächste Rechenära.', '#8a4dff', 'tech'],
    ...
    [9, 'elektromobilitaet', 'Elektromobilität', 'Elektroautos und EV-Technologie', 'Der Antrieb der nächsten Generation.', 'Leise. Elektrisch. Schnell.', '#1fb37a', 'consumer', 'thema-mobilitaet'],
