...
| RISK | SPY (S&P-500-Markttracker): 20-Tage-Volatilität (annualisiert), Abstand zum 52-Wochen-Hoch | NORMAL / ELEVATED / HIGH | Volatilität ≥ p75 (19,7 %) bzw. ≥ p90 (26,9 %) der eigenen SPY-Historie seit 1995; Rückgang ≤ −10 % / ≤ −20 %. Es gilt die höhere Stufe. | Volatilität **kalibriert**, Rückgang Marktkonvention |
...
- **Risiko-Referenz:** Die Reihe ist ausschließlich `quant/data/market/multi-asset/series/SPY.json`. Das ist der S&P-500-Markttracker SPY über den bestehenden, lizenzierten Tiingo-Pfad (`tiingo-equity`, LICENSE_CONFIRMED): split-bereinigte Schlusskurse ohne Ausschüttungen, 03.01.1995–heute. Es ist ein ETF-Anteilspreis und **kein** S&P-500-Indexstand. FMP, FRED oder eine andere S&P-500-Indexreihe werden nicht verwendet. Der Builder bricht ab, wenn die Reihe nicht SPY/`tiingo-equity`/PRICE ist, und ein Test hält das fest.
