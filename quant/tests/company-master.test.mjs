...
test("die Suche findet einen Titel ausserhalb der alten 498", { skip: !vorhanden }, async () => {
  ...
  /* Seit Discover das ganze Produktuniversum indexiert, steht PLTR auch im
     ausgelieferten Index; das Verzeichnis muss ihn unabhaengig davon finden. */
  assert.ok(alt.size > 498, "der ausgelieferte Index ist nicht mehr die alte 498er-Liste");
});
