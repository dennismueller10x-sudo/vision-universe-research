...
(function (global) {
  ...
  var FIELD_LIST = [
    ...
    /* technicalStructure traegt die Politik CONFIRMS_WITH_DELAY: sein Regime
       zaehlt auch Close-Brueche mit, die eine spaetere Pivot-Bestaetigung
       zuruecknehmen kann. Fuer eine Regel, die einen Zustand behauptet, ist
       das die falsche Zahl. Dieses Feld traegt ausschliesslich das rein
       pivot-bestaetigte Regime und aendert sich nicht rueckwirkend. */
    f("technicalConfirmedStructure", "Technical Market Structure (bestaetigt)", "enum", null, "technical", { values: ["BULLISH", "BEARISH", "RANGE", "UNDETERMINED"], availability: "CURRENT_SNAPSHOT_ONLY", backtestEligibility: "NOT_CERTIFIED", isProbability: false, description: "Rein pivot-bestaetigter Marktstruktur-Zustand auf der Setup-Skala; nicht rueckwirkend revidierbar" }),
