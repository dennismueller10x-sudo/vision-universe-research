    ...
    connectedCallback() {
      ...
      root.innerHTML = `<style>
        ...
        *{box-sizing:border-box}header{background:rgba(255,255,255,.96);backdrop-filter:blur(18px);border-bottom:1px solid rgba(0,0,0,.07)}
        ...
        .preview{display:inline-flex;align-items:center;min-height:26px;padding:5px 9px;border:1px solid rgba(17,17,17,.2);border-radius:999px;background:#f4f3ef;color:#34332f;font-size:9px;font-weight:800;line-height:1;letter-spacing:.13em;text-transform:uppercase;white-space:nowrap}
