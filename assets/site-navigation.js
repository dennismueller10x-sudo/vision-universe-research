...
(() => {
  ...
  const styles = (t) => `
        ...
        *{box-sizing:border-box}header{background:${t.bg};backdrop-filter:blur(18px);border-bottom:1px solid ${t.border}}
        ...
        @media(max-width:760px){.shell{width:calc(100% - 32px)}.row{height:70px;gap:12px}.brand{gap:8px}img{width:154px;max-width:48vw}nav.open{top:70px;max-height:calc(100dvh - 70px)}}
